...
def NML_gaussian(window, h):
    ...
    change_score = window_size * np.log(std_all) - h * np.log(std_before) - (window_size - h) * np.log(std_after) + complexity_gaussian(window_size) - complexity_gaussian(h) - complexity_gaussian(window_size - h)
